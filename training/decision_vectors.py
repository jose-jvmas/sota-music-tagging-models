...
class Predict(object):
    ...
    def save_vector(self, estimated, gt, corpus, model_name, partition):
        ...
        with open(os.path.join(base_path, corpus, model_name, partition + '_est.csv'), 'a+') as fout:
            fout.write(",".join([str(u) for u in estimated]) + '\n')
